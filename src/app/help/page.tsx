  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <main className="mx-auto max-w-3xl px-4 py-12">
        ...
        <p className="mt-2 text-gray-600">常见问题解答，帮助您快速上手 OutreachHub</p>
        ...
        <div className="mt-12 rounded-xl bg-gray-50 p-8 text-center dark:bg-gray-900">
          ...
          <h3 className="mt-3 text-lg font-semibold">没有找到答案？</h3>
          <p className="mt-1 text-gray-600">联系我们的客服团队获取帮助</p>
