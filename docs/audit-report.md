...
### ��9.64 ���ٿ�ʼҳ�ڱջ���2026-07-26��

**Ŀ�꣺** �� `/dashboard/getting-started` �� deep-link ������Ϊҳ�ڱջ����������� �� ICP �� ����/CSV ��� �� ������֤ �� ���򽨻 �� ������

| ��� | ���� | �ؼ��ļ� |
|------|------|----------|
| GS1 | ��״̬�� + localStorage �־û� + ��ʵ��ɶ� checklist | `src/components/getting-started/*` |
| GS2 | ǰ�� SMTP �˻����/���㴴�� | `StepPrereq.tsx` |
| GS3 | ICP + ��ѡ AI �ش� | `StepIcp.tsx` |
| GS4 | search-people-multi ��ѡ��⣻�� Key ʱ CSV ���� | `StepProspect.tsx` |
| GS5 | verify-batch + �ɷ�������ɸѡ | `StepVerify.tsx` |
| GS6 | POST+PATCH Campaign + launch | `StepCampaign.tsx`, `StepLaunch.tsx`, `api.ts` |
| GS7 | ҳ���Ϊ���� `GettingStartedWizard` | `src/app/dashboard/getting-started/page.tsx` |

**�ܹ����ߣ�**
- ��Ƕ������ `campaign-wizard`�������� `/campaigns/new` ȫ�� store ��ͻ����
- ���ز����ջ���·���������䣩�����ؿ� Key ʱǿ�� CSV ���ס�
- Campaign ���������� PATCH `contactIds`���� `replaceCampaignContacts`��

**��֤��** `npm run build`����������ʱִ�У���
